# Tracked override of the beloglazov omf theme's prompt.
# ~/.config/fish/functions precedes the omf theme dirs on $fish_function_path,
# so this autoloads in place of the framework copy and survives omf reinstalls.
# Only change from upstream: 24-hour clock (%H) instead of 12-hour (%I) on the time line.
...
function fish_prompt
  ...
  set -l time $red(date '+%H:%M')$normal
